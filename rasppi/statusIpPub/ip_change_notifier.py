...
from_address = 'system.bordignon@gmail.com'
to_address = 'alessio.bordignon@gmail.com'
subject = 'Pi IP'
username = 'system.bordignon@gmail.com'
password = 'sunsunsun1A'
...
with open('/home/ale/ipemail/last_ip.txt', 'rt') as last_ip:
...
if last_ip == ourIP:
    ...
    with open('/home/ale/ipemail/last_ip.txt', 'wt') as last_ip:
        last_ip.write(ourIP)
